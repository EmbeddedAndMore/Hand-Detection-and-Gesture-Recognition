...
///////////////////////////////////////////////////////////////////////////////////////////////////
void Tracker::addBoundingRect(cv::Rect BoundingRect)
{
	currentBoundingRect = BoundingRect;
	...
	addCenterPosition(currentCenter);
}

///////////////////////////////////////////////////////////////////////////////////////////////////
cv::Point Tracker::predictNextPosition(void) {

	numPositions = centerPositions.size();

	
	if (numPositions == 1) {

		return(centerPositions[0]);
